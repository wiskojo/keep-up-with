...
- **Research the context (BFS):** Check adjacent links, prior art, related ideas, competing work, similar launches, comments, benchmarks, older claims, critiques, and close comparables. Name the relationship. If there’s an obvious closest comparison, research it.
...
- **Choose the right visual:** Choose visuals based on what each highlight needs to convey. Source visuals are often best because the authors designed them to explain their own point. Use custom visuals when they make the point clearer, easier to verify, easier to compare, or less dense.
...
- **Keep it readable:** Spend words on the event, mechanism, evidence, and consequence instead of unnecessary names. Avoid wall-of-text posts; use spacing, emphasis, visuals, quotes, and post breaks. Frame the thread around sourced claims, comparisons, deltas, open questions, and caveats, not personal takes.
