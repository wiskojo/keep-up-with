...
- For GitHub repo events, the first image should be a sensible screenshot crop of the repo itself. For this case, expect a repo README image, a how-it-works image, a benchmark chart, and a star-history chart made with `kup-cli tools repo star-history`.
